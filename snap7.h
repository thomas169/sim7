...
//                                   SERVER
//******************************************************************************
static const int OperationRead  = 0;
static const int OperationWrite = 1;

static const int mkEvent = 0;
static const int mkLog   = 1;

// Server Area ID  (use with Register/unregister - Lock/unlock Area)
static const int srvAreaPE = 0;
static const int srvAreaPA = 1;
static const int srvAreaMK = 2;
static const int srvAreaCT = 3;
static const int srvAreaTM = 4;
static const int srvAreaDB = 5;

// Errors
static const longword errSrvCannotStart        = 0x00100000; // Server cannot start
static const longword errSrvDBNullPointer      = 0x00200000; // Passed null as PData
static const longword errSrvAreaAlreadyExists  = 0x00300000; // Area Re-registration
static const longword errSrvUnknownArea        = 0x00400000; // Unknown area
static const longword errSrvInvalidParams      = 0x00500000; // Invalid param(s) supplied
static const longword errSrvTooManyDB          = 0x00600000; // Cannot register DB
static const longword errSrvInvalidParamNumber = 0x00700000; // Invalid param (srv_get/set_param)
static const longword errSrvCannotChangeParam  = 0x00800000; // Cannot change because running

// TCP Server Event codes
static const longword evcServerStarted       = 0x00000001;
static const longword evcServerStopped       = 0x00000002;
static const longword evcListenerCannotStart = 0x00000004;
static const longword evcClientAdded         = 0x00000008;
static const longword evcClientRejected      = 0x00000010;
static const longword evcClientNoRoom        = 0x00000020;
static const longword evcClientException     = 0x00000040;
static const longword evcClientDisconnected  = 0x00000080;
static const longword evcClientTerminated    = 0x00000100;
static const longword evcClientsDropped      = 0x00000200;
static const longword evcReserved_00000400   = 0x00000400; // actually unused
static const longword evcReserved_00000800   = 0x00000800; // actually unused
static const longword evcReserved_00001000   = 0x00001000; // actually unused
static const longword evcReserved_00002000   = 0x00002000; // actually unused
static const longword evcReserved_00004000   = 0x00004000; // actually unused
static const longword evcReserved_00008000   = 0x00008000; // actually unused
// S7 Server Event Code
static const longword evcPDUincoming  	      = 0x00010000;
static const longword evcDataRead            = 0x00020000;
static const longword evcDataWrite    	      = 0x00040000;
static const longword evcNegotiatePDU        = 0x00080000;
static const longword evcReadSZL             = 0x00100000;
static const longword evcClock               = 0x00200000;
static const longword evcUpload              = 0x00400000;
static const longword evcDownload            = 0x00800000;
static const longword evcDirectory           = 0x01000000;
static const longword evcSecurity            = 0x02000000;
static const longword evcControl             = 0x04000000;
static const longword evcReserved_08000000   = 0x08000000; // actually unused
static const longword evcReserved_10000000   = 0x10000000; // actually unused
static const longword evcReserved_20000000   = 0x20000000; // actually unused
static const longword evcReserved_40000000   = 0x40000000; // actually unused
static const longword evcReserved_80000000   = 0x80000000; // actually unused
// Masks to enable/disable all events
static const longword evcAll                 = 0xFFFFFFFF;
static const longword evcNone                = 0x00000000;
// Event SubCodes
static const word evsUnknown                 = 0x0000;
static const word evsStartUpload             = 0x0001;
static const word evsStartDownload           = 0x0001;
static const word evsGetBlockList            = 0x0001;
static const word evsStartListBoT            = 0x0002;
static const word evsListBoT                 = 0x0003;
static const word evsGetBlockInfo            = 0x0004;
static const word evsGetClock                = 0x0001;
static const word evsSetClock                = 0x0002;
static const word evsSetPassword             = 0x0001;
static const word evsClrPassword             = 0x0002;
// Event Params : functions group
static const word grProgrammer               = 0x0041;
static const word grCyclicData               = 0x0042;
static const word grBlocksInfo               = 0x0043;
static const word grSZL                      = 0x0044;
static const word grPassword                 = 0x0045;
static const word grBSend                    = 0x0046;
static const word grClock                    = 0x0047;
static const word grSecurity                 = 0x0045;
// Event Params : control codes
static const word CodeControlUnknown         = 0x0000;
static const word CodeControlColdStart       = 0x0001;
static const word CodeControlWarmStart       = 0x0002;
static const word CodeControlStop            = 0x0003;
static const word CodeControlCompress        = 0x0004;
static const word CodeControlCpyRamRom       = 0x0005;
static const word CodeControlInsDel          = 0x0006;
// Event Result
static const word evrNoError                 = 0x0000;
static const word evrFragmentRejected        = 0x0001;
static const word evrMalformedPDU            = 0x0002;
static const word evrSparseBytes             = 0x0003;
static const word evrCannotHandlePDU         = 0x0004;
static const word evrNotImplemented          = 0x0005;
static const word evrErrException            = 0x0006;
static const word evrErrAreaNotFound         = 0x0007;
static const word evrErrOutOfRange           = 0x0008;
static const word evrErrOverPDU              = 0x0009;
static const word evrErrTransportSize        = 0x000A;
static const word evrInvalidGroupUData       = 0x000B;
static const word evrInvalidSZL              = 0x000C;
static const word evrDataSizeMismatch        = 0x000D;
static const word evrCannotUpload            = 0x000E;
static const word evrCannotDownload          = 0x000F;
static const word evrUploadInvalidID         = 0x0010;
static const word evrResNotFound             = 0x0011;
...
// Status
static const int par_stopped         = 0;   // stopped
static const int par_connecting      = 1;   // running and active connecting
static const int par_waiting         = 2;   // running and waiting for a connection
static const int par_linked          = 3;   // running and connected : linked
static const int par_sending         = 4;   // sending data
static const int par_receiving       = 5;   // receiving data
static const int par_binderror       = 6;   // error starting passive server

// Errors
static const longword errParAddressInUse       = 0x00200000;
static const longword errParNoRoom             = 0x00300000;
static const longword errServerNoRoom          = 0x00400000;
static const longword errParInvalidParams      = 0x00500000;
static const longword errParNotLinked          = 0x00600000;
static const longword errParBusy               = 0x00700000;
static const longword errParFrameTimeout       = 0x00800000;
static const longword errParInvalidPDU         = 0x00900000;
static const longword errParSendTimeout        = 0x00A00000;
static const longword errParRecvTimeout        = 0x00B00000;
static const longword errParSendRefused        = 0x00C00000;
static const longword errParNegotiatingPDU     = 0x00D00000;
static const longword errParSendingBlock       = 0x00E00000;
static const longword errParRecvingBlock       = 0x00F00000;
static const longword errParBindError          = 0x01000000;
static const longword errParDestroying         = 0x01100000;
static const longword errParInvalidParamNumber = 0x01200000; // Invalid param (par_get/set_param)
static const longword errParCannotChangeParam  = 0x01300000; // Cannot change because running
static const longword errParBufferTooSmall     = 0x01400000; // Raised by LabVIEW wrapper

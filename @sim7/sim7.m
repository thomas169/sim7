    ...
    methods(Access = protected, Static)
        ...
        function header = getHeaderImpl
            ...
            header = matlab.system.display.Header(mfilename('class'), ...
                ...
                'byte sized arrays. Codegen only. Linux only. Note snap7.h '...
                'must be changed to work with matlab. For this you must: '...
                '1) remove the bool typedef 2) guard the true/false '...
                'defines, 3) add static keyword to all const variable '...
                'declarations.']);
        end
